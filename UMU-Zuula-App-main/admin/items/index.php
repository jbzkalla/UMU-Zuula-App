						...
						?>
							<tr>
								...
								<td class="text-center">
									<img src="<?= validate_image($row['image_path']) ?>" alt="" class="img-thumbnail rounded-0" style="width:50px;height:50px;object-fit:cover;">
								</td>
								<td><?= $row['fullname'] ?></td>
								<td><p class="truncate-1 mb-0" style="max-width:250px"><?= $row['title'] ?></p></td>
								<td class="text-center">
									<?php if($row['status'] == 1): ?>
										<span class="badge bg-danger px-3 rounded-pill shadow-sm">Lost</span>
									<?php elseif($row['status'] == 2): ?>
										<span class="badge bg-success px-3 rounded-pill shadow-sm">Found</span>
									<?php elseif($row['status'] == 3): ?>
										<span class="badge bg-primary px-3 rounded-pill shadow-sm">Claimed</span>
									<?php else: ?>
										<span class="badge bg-secondary px-3 rounded-pill shadow-sm">Pending</span>
									<?php endif; ?>
								</td>
								<td align="center">
									<div class="dropdown">
