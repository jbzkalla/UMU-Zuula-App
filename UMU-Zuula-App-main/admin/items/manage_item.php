					...
					<form action="" id="items-form">
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<select name="status" id="status" class="form-select form-select-sm rounded-pill" required="required">
									<option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Pending Review</option>
									<option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Published (Lost Item)</option>
									<option value="2" <?= isset($status) && $status == 2 ? 'selected' : '' ?>>Published (Found Item)</option>
									<option value="3" <?= isset($status) && $status == 3 ? 'selected' : '' ?>>Claimed / Resolved</option>
								</select>
							</div>
						</div>
					</form>
