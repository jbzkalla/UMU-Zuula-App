                ...
                <div class="container-fluid mt-4">
                    ...
                    <dl>
                      ...
                      <dt class="text-muted">Status</dt>
                        <dd class="ps-4">
                            <?php if($status == 1): ?>
                                <span class="badge bg-danger px-3 rounded-pill">Lost</span>
                            <?php elseif($status == 2): ?>
                                <span class="badge bg-success px-3 rounded-pill">Found</span>
                            <?php elseif($status == 3): ?>
                                <span class="badge bg-primary px-3 rounded-pill">Claimed</span>
                            <?php else: ?>
